          ...
          <div className='row pd-top-120'>
            ...
            >
              <div className='section-title mb-0 mt-4 mt-lg-0'>
                <h6 className='sub-title'>SOME FAQ'S</h6>
                <h2 className='title'>
                  Your <span>Accounting</span> Questions Answered
                </h2>
                <p className='content'>
                  We understand that financial matters can be complex. Here are some frequently asked questions to help you navigate your accounting needs.
                </p>
              </div>
              <div
                className='accordion accordion-inner style-2 accordion-icon-left mt-3'
